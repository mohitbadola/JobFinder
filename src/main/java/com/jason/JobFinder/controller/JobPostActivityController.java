...
import com.jason.JobFinder.entity.*;
import com.jason.JobFinder.services.JobPostActivityService;
import com.jason.JobFinder.services.JobSeekerApplyService;
import com.jason.JobFinder.services.JobSeekerSaveService;
...
public class JobPostActivityController {
    ...
    public String searchJobs(Model model, @RequestParam(value = "job", required = false) String job,
        ...
        model.addAttribute("today", Objects.equals(today, "today"));
        model.addAttribute("day7", Objects.equals(days7, "days7"));
        model.addAttribute("days30", Objects.equals(days30, "days30"));

        model.addAttribute("job", Objects.equals(job, "job"));
        model.addAttribute("location", Objects.equals(location, "location"));
